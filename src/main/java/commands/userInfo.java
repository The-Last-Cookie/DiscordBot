...
public class userInfo extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent event) {
        ...
        try {
            if (args[0].equalsIgnoreCase(Static.prefix + "userinfo")) { //provides info about specific user
            ...
            EmbedBuilder info = new EmbedBuilder()
                    .setTitle("User Information")
                    .addField("How to use this command", Static.prefix + "serverInfo @[username]", false)
                    .addField("Example", Static.prefix + "serverInfo @TheLastCookie", false)
                    .setColor(0xf45642);
